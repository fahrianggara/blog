                ...
                <form action="{{ route('roles.update', ['role' => $role]) }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="input_role_name" value="{{ old('name', $role->name) }}"
                                placeholder="{{ trans('roles.form_control.input.name.placeholder') }}" name="name"
                        ...
                        <div class="float-right mb-4">
                            <a class="btn btn-info px-4 mx-2" href="{{ route('roles.index') }}">
